...
\part{Le cadre du stage}
	...
	\section{La vie en société}
		\subsection{L’articulation des différents départements}
		\subsection{Les relations humaines entre les employés}

\newpage
\rhead{Travaux effectués et apports du stage}
\part{Travaux effectués et apports du stage}
	\section{Introduction}
		La mission principale du stage consisté à étudier l'accélerateur d'Intel. Le but étant d'évaluer les performances de la carte,
