		...
		\subsection{Les missions}
			\subsubsection{Knights Ferry}
				...
				à certaine partie de la carte, comme le processeur ou la mémoire.
					...
					La première implémentation du test s'exécuter sur la machine hôte, et seule la partie de calcul était 
					...
					parties transfert de données vers la carte des parties de calcul pour pouvoir être sûr de ne mesurer que 
					les calculs effectués sur le Knights Ferry.
					\begin{figure}[!ht]
					\begin{center}
					\includegraphics[scale=0.5]{gflops_SGEMM.png}
