...
\part{Travaux effectués et apports du stage}
	\section{Travaux effectués}
		\subsection{Introduction}
			1) Travaux sur Knights Ferry, étude de performance
			\newline{}
			2) Diverses mesures sur GPU avec Centrale et le CEA projet OpenGPU
			\newline{}
			3) Knights Corner?
			\newline{}
		\subsection{Les outils}
			Un PC perso avec OS au choix, choix de Linux (Ubuntu).
			Un PC avec avec une Redhat Entreprise et le MIC.
			Utilisation des lames de Bull pour les tests sur GPU.
			Accès à un PC distant à Echirolles pour les travaux sur Knights Corner.
